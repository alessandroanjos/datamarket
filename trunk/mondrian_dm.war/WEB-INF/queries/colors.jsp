...
<jp:mondrianQuery id="query01" jdbcDriver="org.postgresql.Driver" jdbcUser="postgres" jdbcPassword="001100" jdbcUrl="jdbc:postgresql://localhost/gsan_admin" catalogUri="/WEB-INF/queries/FoodMart.xml">
