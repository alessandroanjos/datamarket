							...
							<ul>
								...
								<li class="normal">
									<div>
										...
										<h:inputText styleClass="field text" id="id" maxlength="2" onkeypress="return SoNumero(event);"
											value="#{estoqueBB.id}" size="2"  readonly="true">
								...
								<li class="buttons">
									<h:commandButton styleClass="btTxt" id="botaoVoltar" immediate="true" action="#{estoqueBB.voltarConsulta}" value="Voltar"></h:commandButton>									
