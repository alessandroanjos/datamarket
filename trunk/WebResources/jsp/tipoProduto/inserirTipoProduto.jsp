					...
					<div class="centro">
						<div id="loginUser">
							...
							<strong><h:outputText id="usuario"
									value="#{loginBB.usuarioLogado.nome}"></h:outputText> </strong>
							&nbsp;&nbsp;&nbsp;&#8212;&nbsp;&nbsp;&nbsp;
							<script>document.write(day)</script>,&nbsp;<script>document.write(today+"/"+month+"/"+year)</script>
						</div>
						<div id="breadcrumb">
								...
								<li class="normal">
									<div>
										...
										<h:inputText styleClass="field text ativo" id="id"
											maxlength="2" value="#{tipoProdutoBB.id}" size="2"
											required="true">
