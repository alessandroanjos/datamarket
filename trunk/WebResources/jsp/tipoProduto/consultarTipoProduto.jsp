	...
	<div id="outer">
		<div id="topoGeral">
			<div id="tituloPaginaGeral">
				<strong>
					<h:outputText value="#{msgs.consultarTipoProduto}"></h:outputText>
				</strong>
			</div>				
		</div>	
		<h:form id="frmConsultarTipoProduto" binding="#{tipoProdutoBB.init}">
				...
				<div class="jqmAlert" id="alerta"><div class="jqmAlertWindow"><div class="jqmAlertTitle clearfix"><a href="#" onclick="javascript:fecharAlerta();" class="jqmClose"><em>Fechar</em></a><h1>Alerta</h1></div><div class="jqmAlertContent" id="jqmAlertContent"></div><input type="button" value="Ok" onclick="javascript:fecharAlerta();" /></div></div><div id="content">
						...
						<div id="primarioContentContainer">
							...
							<div class="listagem">
								<t:dataTable value="#{tipoProdutoBB.tiposProduto}"
									var="tipos" rowClasses="rowA,rowB" width="95%" renderedIfEmpty="false">
									<h:column>
										<f:facet name="header">
									...
									<h:column>
										...
										<h:commandLink value="#{tipos.descricao}" action="#{tipoProdutoBB.consultar}">
											<f:param name="id" value="#{tipos.id}"/>						
										</h:commandLink>
									</h:column>									
								</t:dataTable>																
								<ul>
									<li class="normal">
										<div>
											<%@ include file="/jsp/mensagem_erro.jsp"%> <!--  h  messages rendered="#{not tipoProdutoBB.existeRegistros}" errorClass="msgSistemaErro" infoClass="msgSistemaSucesso" globalOnly="true" showDetail="true" /> -->
										</div>
									</li>
								</ul>
							</div>
...
<h:commandButton styleClass="btTxt" action="#{tipoProdutoBB.resetBB}" id="botaoLimpar" value="Limpar"></h:commandButton>
									<h:commandButton styleClass="btTxt" id="botaoConsultar" action="#{tipoProdutoBB.consultar}" value="Consultar"></h:commandButton>
								</li>						
							</ul>
						</div>
						<div class="clear"></div>
