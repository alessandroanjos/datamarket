...
<body>
	<div>
	<h:outputText id="titulo" styleClass="label" value="Home > Tipo de Produto"></h:outputText>
	</div>
	<br>
	<div>
	...
	<h:form>
		...
		<h:panelGrid columns="3" id="formGrid1">	
			<h:commandButton onmouseover="this.className='inputBtnhov'" onmouseout="this.className='inputBtn'" styleClass="inputBtn" id="botaoVoltar" action="#{tipoProdutoBB.voltarMenu}" value="Voltar"></h:commandButton>
			...
			<h:commandButton onmouseover="this.className='inputBtnhov'" onmouseout="this.className='inputBtn'" styleClass="inputBtn" id="botaoConsultar" action="#{tipoProdutoBB.consultar}" value="Consultar"></h:commandButton>
		</h:panelGrid>
		<p>
		<h:dataTable value="#{tipoProdutoBB.tiposProduto}"
					var="tipoProduto">
					<f:facet name="header">
					...
					<h:column>
						...
						<h:outputText styleClass="label" value="#{tipoProduto.id}" /> 
					</h:column>
					<h:column>
						<f:facet name="header">
							<h:outputText styleClass="label"  value="Descrição" />
						</f:facet>
						<h:commandLink styleClass="label" value="#{tipoProduto.descricao}" action="#{tipoProdutoBB.consultar}">
							<f:param name="id" value="#{tipoProduto.id}"/>						
						</h:commandLink>
					</h:column>
