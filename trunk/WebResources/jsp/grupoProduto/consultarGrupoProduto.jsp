	...
	<div id="outer">
		<div id="topoGeral">
			<div id="tituloPaginaGeral">
				<strong>
					<h:outputText value="#{msgs.consultarGrupoProduto}"></h:outputText>
				</strong>
			</div>				
		</div>		
		
		<h:form id="frmConsultarGrupoProduto" binding="#{grupoProdutoBB.init}">
				<div id="content">
									...
									<li class="normal">
										<div>
											...
											<h:inputText styleClass="field text ativo" id="id" maxlength="4"
												value="#{grupoProdutoBB.id}" size="4" required="false">
							...
							<div class="listagem">
								<t:dataTable value="#{grupoProdutoBB.gruposProduto}"
									...
									<h:column>
										...
										<h:commandLink value="#{grupos.descricao}" action="#{grupoProdutoBB.consultar}">
											<f:param name="id" value="#{grupos.id}"/>						
										</h:commandLink>
									</h:column>
									<h:column>
										<f:facet name="header">
											<h:outputText value="Grupo Superior" />
										</f:facet>
								...
								<ul>
									<li class="normal">
										<div>
											<%@ include file="/jsp/mensagem_erro.jsp"%> <!--  h  messages rendered="#{not grupoProdutoBB.existeRegistros}" errorClass="msgSistemaErro" infoClass="msgSistemaSucesso" globalOnly="true" showDetail="true" /> -->
										</div>
									</li>
								</ul>															
							</div>
