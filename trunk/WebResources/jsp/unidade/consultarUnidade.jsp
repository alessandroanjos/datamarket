						...
						<div id="primarioContentContainerInternas">
							...
							<div class="listagem">
								<t:dataTable value="#{unidadeBB.unidades}"
									...
									<h:column>
										<f:facet name="header">
											<h:outputText value="Descrição Compacta" /> 
										</f:facet>
								...
								<ul>
									<li class="normal">
										<div>
											<%@ include file="/jsp/mensagem_erro.jsp"%> <!--  h  messages rendered="#{not unidadeBB.existeRegistros}" errorClass="msgSistemaErro" infoClass="msgSistemaSucesso" globalOnly="true" showDetail="true" /> -->
										</div>
									</li>
								</ul>
							</div>
