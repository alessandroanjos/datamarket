...
<h:form>
	<div>
	<h:outputText id="titulo" styleClass="label" value="Home > Inserir Componente"></h:outputText>
	</div>
	<br>
	<div>
		...
		<h:panelGrid  columns="3" id="formGrid1">
			<h:commandButton onmouseover="this.className='inputBtnhov'" onmouseout="this.className='inputBtn'" immediate="true" styleClass="inputBtn" id="botaoVoltar" action="#{componenteBB.voltarMenu}" value="Voltar"></h:commandButton>
			...
			<h:commandButton onmouseover="this.className='inputBtnhov'" onmouseout="this.className='inputBtn'" styleClass="inputBtn" id="botaoInserir" action="#{componenteBB.inserir}" value="Inserir"></h:commandButton>
		</h:panelGrid>
</h:form>	
</body>
</f:view>
