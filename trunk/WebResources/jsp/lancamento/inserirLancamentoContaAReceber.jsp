	...
	<div id="outer">
		<div id="topoGeral">
			<div id="tituloPaginaGeral">
				<strong>
					<h:outputText value="#{msgs.inserirContaAReceber}"></h:outputText>
				</strong>
			</div>				
		</div>
		<h:form id="frmInserirLancamentoContaAReceber" binding="#{lancamentoBB.init}">
				<div id="content">
						<div id="primarioContentContainerInternas">
							<ul>
								...
								<li class="buttons">
									...
									<h:commandButton styleClass="btTxt" id="botaoInserir" action="#{lancamentoBB.inserirContaAReceber}" value="Inserir"></h:commandButton>
								</li>
							</ul>
						</div>
						<div class="clear"></div>
