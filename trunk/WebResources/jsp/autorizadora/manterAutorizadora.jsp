	...
	<head>
		...
		<h:form id="frmManterAutorizadora">
				...
				<f:subview id="subTopo" rendered="true">
					<jsp:include page="/jsp/topo.jsp?tituloPagina=#{msgs.manterAutorizadora}&user=#{loginBB.usuarioLogado.nome}"></jsp:include>	
				</f:subview>					
				<div id="content">
								...
								<li class="normal">
									<div>
										...
										<h:inputText styleClass="field text ativo" id="id" maxlength="2"
											value="#{autorizadoraBB.id}" size="3" rendered="true" readonly="true">
