...
<body>
	...
	<h:form>
		<h:panelGrid columns="3" id="formGrid">
			...
			<t:inputCalendar readonly="false"  styleClass="inputText" forceId="dataInicioValidade" value="#{planoPagamentoBB.dataInicioValidade}" id="dataInicioValidade" renderAsPopup="true"
