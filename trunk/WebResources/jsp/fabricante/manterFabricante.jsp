	...
	<div id="outer">
		<div id="topoGeral">
			<div id="tituloPaginaGeral">
				<strong>
					<h:outputText value="#{msgs.manterFabricante}"></h:outputText>
				</strong>
			</div>				
		</div>			
				<div id="content">
...
<!-- xxxxxxxxxxxxxxx -->					
							...
							<ul>
								...
								<li class="normal">
									<div>
										...
										<h:inputText styleClass="field text ativo" id="id"
											maxlength="4" value="#{fabricanteBB.id}" size="4" readonly="true"
											>
								...
								<li class="normal">
									<div>
										...
										<h:selectOneRadio  styleClass="field select tipopessoa" id="tipoPessoa" 
											value="#{fabricanteBB.idTipoPessoa}" layout="lineDirection"  disabled="false">
								...
								<li class="normal">
									<div>
										...
										<h:inputText styleClass="field text" id="cpfCnpj" maxlength="18" size="18" value="#{fabricanteBB.cpfCnpj}"  disabled="true">
						...
						<ul>
							<li class="buttons">
								<h:commandButton styleClass="btTxt" immediate="true" id="botaoVoltar" action="#{fabricanteBB.voltarConsulta}" value="Voltar"></h:commandButton>							
								<h:commandButton styleClass="btTxt" id="botaoAlterar" action="#{fabricanteBB.alterar}" value="Alterar"></h:commandButton>
								<h:commandButton styleClass="btTxt" id="botaoExcluir" action="#{fabricanteBB.excluir}" value="Excluir"></h:commandButton>								
							</li>
						</ul>
<!-- xxxxxxxxxxxxxxx -->					
		</h:form>		
