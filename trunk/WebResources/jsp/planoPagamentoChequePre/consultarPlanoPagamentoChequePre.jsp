...
<f:view>
	...
	<head>
		...
		<h:form id="frmConsultarPlanoPagamentoChequePre">
				<f:subview id="subTopo" rendered="true">
					
					<jsp:include page="/jsp/topo.jsp?tituloPagina=#{msgs.consultarPlanoPagamentoChequePre}&user=#{loginBB.usuarioLogado.nome}"></jsp:include>	
				</f:subview>					
				<div id="content">
							...
							<div class="listagem">
								<t:dataTable value="#{planoPagamentoChequePreBB.planos}"
									...
									<h:column>
										...
										<h:outputText value="#{planosChequePre.id}" /> 
									</h:column>
									<h:column>
										<f:facet name="header">
