	...
	<div id="outer">
		<div id="topoGeral">
			<div id="tituloPaginaGeral">
				<strong>
					<h:outputText value="#{msgs.relatorioAnaliticoLancamentosContasAReceber}"></h:outputText>
				</strong>
			</div>				
		</div>		
		<h:form id="frmRelatorioAnaliticoLancamentoContaAReceber" binding="#{relatorioBB.init}">				
				<div id="content">				
								...
								<ul>								
									<li class="normal">
										...
										<div>
											...
											<h:selectOneRadio  styleClass="field select" id="idTipoRelatorioContasAReceber" 
												value="#{relatorioBB.idTipoRelatorioContasAReceber}" layout="lineDirection" required="false">
												<f:selectItems id="tipoPessoaLista" value="#{relatorioBB.listaTipoRelatorioContasAReceber}"/>
											</h:selectOneRadio>
										</div>
									</li>
								</ul>
