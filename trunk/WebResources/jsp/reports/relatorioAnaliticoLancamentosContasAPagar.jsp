	...
	<div id="outer">
		<div id="topoGeral">
			<div id="tituloPaginaGeral">
				<strong>
					<h:outputText value="#{msgs.relatorioAnaliticoLancamentosContasAPagar}"></h:outputText>
				</strong>
			</div>				
		</div>		
		<h:form id="frmRelatorioAnaliticoLancamentoContaAPagar" binding="#{relatorioBB.init}">				
				<div id="content">				
						<div id="primarioContentContainer">
							<fieldset>
								...
								<ul>								
									<li class="normal">
										...
										<div>
											<h:outputLabel styleClass="desc" value="Grupo de Lançamento" rendered="true"></h:outputLabel>										
										...
										<br />
										<div>
											<h:outputLabel styleClass="desc" value=""></h:outputLabel>
											<h:selectOneRadio  styleClass="field select" id="idTipoRelatorioContasAPagar" 
												value="#{relatorioBB.idTipoRelatorioContasAPagar}" layout="lineDirection" required="false">
												<f:selectItems id="tipoPessoaLista" value="#{relatorioBB.listaTipoRelatorioContasAPagar}"/>
											</h:selectOneRadio>
										</div>
									</li>
								</ul>
							...
							<ul>
								...
								<li class="buttons">
									<h:commandButton styleClass="btTxt" action="#{relatorioBB.limparRelatorioAnaliticoLancamentosContasAPagar}" id="botaoLimpar" value="Limpar"></h:commandButton>
									<h:commandButton styleClass="btTxt" id="botaoRelatorio" action="#{relatorioBB.executarRelatorioAnaliticoLancamentosContasAPagar}" value="Relatório"></h:commandButton>
