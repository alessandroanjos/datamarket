	...
	<div id="outer">
		<div id="topoGeral">
			<div id="tituloPaginaGeral">
				<strong>
					<h:outputText value="#{msgs.relatorioAnaliticoEntrada}"></h:outputText>
				</strong>
			</div>				
		</div>		
						...
						<div id="primarioContentContainer">
							...
							<ul>
								...
								<li class="buttons">
									...
									<h:commandButton styleClass="btTxt" id="botaoRelatorio" action="#{relatorioBB.executarRelatorioAnaliticoEntrada}" value="Relatório"></h:commandButton>
								</li>						
							</ul>
						</div>
						<div class="clear"></div>
