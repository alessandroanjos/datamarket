...
public class OpAVConfirmaCancelamentoPedido extends OpAVEncerraPedido {

	public int exec(GerenciadorPerifericos gerenciadorPerifericos, ParametroMacroOperacao param){
		try{
			OperacaoPedido pedido = (OperacaoPedido)gerenciadorPerifericos.getCmos().ler(CMOS.OPERACAO_PEDIDO);

			gerenciadorPerifericos.getDisplay().setMensagem(MensagensAV.getMensagem(this, "Confirma Cancelamento ?"));
			...
			if (entrada.getTeclaFinalizadora() == Tecla.CODIGO_ENTER){
				try{						
					...
					URL urlCon = new URL("http://" +
							...
							"/" +
							ServerConfig.ALTERAR_OPERACA_SERVLET +"?status=" + ConstantesOperacao.CANCELADO);
				...
				gerenciadorPerifericos.getDisplay().setMensagem(MensagensAV.getMensagem(this, "Cancelado com Sucesso"));
