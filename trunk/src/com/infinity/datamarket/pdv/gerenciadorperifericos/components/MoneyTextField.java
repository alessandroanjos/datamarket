...
import javax.swing.SwingUtilities;
	...
	public class MoneyTextField  extends JTextField implements FocusListener,
		 ...
		 */
		public MoneyTextField(String valorInicial) {
			setDocument(new MoneyDocument());
			setHorizontalAlignment(SwingConstants.RIGHT);
			adicionaListeners();
		...
		public double getValor(){
			...
			try {
				MoneyDocument doc = (MoneyDocument) getDocument();
...
//				}
		...
		public static void main(String[] a){
			...
			MoneyTextField b = new MoneyTextField();
