...
insert into funcionalidade values (201,  200, 'Liberar Carga de Dados'              , 'S', 'lote/liberaDados'                                         , 1024  , 768 )
insert into funcionalidade values (202,  200, 'Entrada de Produto'                  , 'S', NULL                                                       , 0     , 0   )
insert into funcionalidade values (203,  202, 'Inserir Entrada de Produtos'         , 'S', 'entradaProduto/inserirEntradaProduto'                     , 1024  , 768 )
insert into funcionalidade values (204,  202, 'Consultar Entrada de Produtos'       , 'S', 'entradaProduto/consultarEntradaProduto'                   , 1024  , 768 )
insert into funcionalidade values (205,  200, 'Movimentações'                       , 'S', NULL                                                       , 1024  , 768 )
insert into funcionalidade values (206,  205, 'Produto entre Estoques'              , 'S', NULL                                                       , 0     , 0   )
insert into funcionalidade values (207,  206, 'Inserir Movimentação'                , 'S', 'movimentacaoEstoque/inserirMovimentacaoEstoque'           , 1024  , 768 )
insert into funcionalidade values (208,  206, 'Consultar Movimentação'              , 'S', 'movimentacaoEstoque/consultarMovimentacaoEstoque'         , 1024  , 768 )
insert into funcionalidade values (209,  205, 'Ajuste de Estoque'                   , 'S', NULL                                                       , 0     , 0   )
insert into funcionalidade values (210,  209, 'Inserir Ajustes de Estoque'          , 'S', 'ajusteEstoque/inserirAjusteEstoque'                       , 1024  , 768 )
insert into funcionalidade values (211,  209, 'Consultar Ajuste de Estoque'         , 'S', 'ajusteEstoque/consultarAjusteEstoque'                     , 1024  , 768 )
insert into funcionalidade values (212,  200, 'Transações'                          , 'S', NULL                                                       , 0     , 0   )
insert into funcionalidade values (213,  212, 'Manter Transação'                    , 'S', 'transacao/consultarTransacao'                             , 1024  , 770 )
insert into funcionalidade values (214,  200, 'Devoluções'                          , 'S', NULL                                                       , 0     , 0   )
insert into funcionalidade values (215,  214, 'Inserir Devolução'                   , 'S', 'devolucao/inserirDevolucao'                               , 1024  , 768 )
insert into funcionalidade values (216,  214, 'Manter Devolução'                    , 'S', 'devolucao/consultarDevolucao'                             , 1024  , 768 )
