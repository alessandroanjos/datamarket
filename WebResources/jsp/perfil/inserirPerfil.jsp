...
<html>
	...
	-->
		<script type="text/javascript" language="javascript"
			src="/EnterpriseServer/js/funcoes.js"></script>
	</head>


	<f:view>
		<t:stylesheet path="/css/style.css"></t:stylesheet>
		<body onload="trocaAba('frmInserirPerfil',1,3)">
			<h:form id="frmInserirPerfil">
					...
					<h:panelGrid columns="1" id="formGeral" border="1" width="450">
						<f:facet name="header">
							<h:panelGrid columns="3" styleClass="fundo-cinza-medio" width="450">
								<h:column>
									<h:outputText id="aba1" style="width=100%;" onclick="trocaAba('frmInserirPerfil',1,3)"
										styleClass="aba-cinza-claro" value="Perfil" />
								</h:column>
								<h:column>
									<h:outputText id="aba2" style="width=100%;" onclick="trocaAba('frmInserirPerfil',2,3)"
										styleClass="aba-cinza-claro" value="Operações Associadas" />
								</h:column>
								<h:column>
									<h:outputText id="aba3" style="width=100%;" onclick="trocaAba('frmInserirPerfil',3,3)"
										styleClass="aba-cinza-claro"
										value="Funcionalidades Associadas" />
								</h:column>
							</h:panelGrid>
						</f:facet>
						<h:panelGrid columns="1" id="formDetalhes">
							<t:div id="Layer1" styleClass="abas-pagto-rec"
								style="position:relative" style="width: 450px; height: 200px;">
								<h:panelGrid columns="3" id="formGridPerfil">
									...
									<h:inputText styleClass="inputText" id="descricao"
										maxlength="20" size="20" value="#{perfilBB.descricao}"
										required="true">
									...
									<h:outputText styleClass="label"
										value="Percentual de Desconto*"></h:outputText>
									<h:inputText styleClass="inputTextRight"
										id="percentualDesconto" maxlength="6" size="6"
										value="#{perfilBB.percentualDesconto}" required="true"
										onkeypress="Formata('frmInserirPerfil:percentualDesconto',5,2);">
										<f:validateLength maximum="6" />
										<f:validateDoubleRange minimum="0.00" maximum="100.00" />
										<f:validator validatorId="BigDecimalValidator" />
									</h:inputText>
									<h:message for="percentualDesconto" showSummary="false"
										styleClass="errors" />
								</h:panelGrid>
							</t:div>
							<t:div id="Layer2" styleClass="abas-pagto-rec"
								style="position:relative" style="width: 450px; height: 200px;">
							...
							<t:div id="Layer3" styleClass="abas-pagto-rec"
								style="position:relative" style="width: 450px; height: 200px;">
								<t:div styleClass="div-auto-scroll"
									style="width: 100%; height: 200px;">
				...
				<h:panelGrid columns="3" id="formGrid1">
					<h:commandButton onmouseover="this.className='inputBtnhov'"
						onmouseout="this.className='inputBtn'" immediate="true"
						styleClass="inputBtn" id="botaoVoltar"
						action="#{perfilBB.voltarMenu}" value="Voltar"></h:commandButton>
					<h:commandButton onmouseover="this.className='inputBtnhov'"
						onmouseout="this.className='inputBtn'" immediate="true"
						styleClass="inputBtn" id="botaoLimpar" type="reset" value="Limpar"></h:commandButton>
					<h:commandButton onmouseover="this.className='inputBtnhov'"
						onmouseout="this.className='inputBtn'" styleClass="inputBtn"
						id="botaoInserir" action="#{perfilBB.inserir}" value="Inserir"></h:commandButton>
				</h:panelGrid>
			</h:form>
		</body>
	</f:view>
