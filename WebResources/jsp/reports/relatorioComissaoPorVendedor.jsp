	...
	<div id="outer">
		<div id="topoGeral">
			<div id="tituloPaginaGeral">
				<strong>
					<h:outputText value="#{msgs.relatorioComissaoPorVendedor}"></h:outputText>
				</strong>
			</div>				
		</div>		
				...
				<div class="jqmAlert" id="alerta"><div class="jqmAlertWindow"><div class="jqmAlertTitle clearfix"><a href="#" onclick="javascript:fecharAlerta();" class="jqmClose"><em>Fechar</em></a><h1>Alerta</h1></div><div class="jqmAlertContent" id="jqmAlertContent"></div><input type="button" value="Ok" onclick="javascript:fecharAlerta();" /></div></div><div id="content">				
						<div id="primarioContentContainer">
							<fieldset>
								...
								<ul>								
									<li class="normal">
										...
										<div>
											<h:outputLabel styleClass="desc" value="Vendedor" rendered="true"></h:outputLabel>										
											<h:selectOneMenu id="idVendedor" style="width: 200px;" value="#{relatorioBB.idVendedor}" rendered="true">  
												<f:selectItems id="vendedoresSelectItems" value="#{relatorioBB.vendedores}" />   
											</h:selectOneMenu>
										</div>
							...
							<ul>
								...
								<li class="buttons">
									<h:commandButton styleClass="btTxt" action="#{relatorioBB.limparRelatorioComissaoPorVendedor}" id="botaoLimpar" value="Limpar"></h:commandButton>
									<h:commandButton styleClass="btTxt" id="botaoRelatorio" action="#{relatorioBB.executarRelatorioComissaoPorVendedor}" value="Relatório"></h:commandButton>
								</li>						
							</ul>
						</div>
						<div class="clear"></div>
