	...
	<div id="outer">
		<div id="topoGeral">
			<div id="tituloPaginaGeral">
				<strong>
					<h:outputText value="#{msgs.relatorioLucroBruto}"></h:outputText>
				</strong>
			</div>				
		</div>		
		<h:form id="frmRelatorioLucroBruto" binding="#{relatorioBB.init}">				
				<div id="content">				
						<div id="primarioContentContainer">
							...
							<ul>
								...
								<li class="buttons">
									<h:commandButton styleClass="btTxt" action="#{relatorioBB.limparRelatorioLucroBruto}" id="botaoLimpar" value="Limpar"></h:commandButton>
									<h:commandButton styleClass="btTxt" id="botaoRelatorio" action="#{relatorioBB.executarRelatorioLucroBruto}" value="Relatório"></h:commandButton>
								</li>						
							</ul>
						</div>
						<div class="clear"></div>
