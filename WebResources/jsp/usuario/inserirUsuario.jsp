  								...
  								<li class="normal">
									...
									<li class="normal">
										<div>
											...
											<h:inputText styleClass="field text comissao" id="comissao" maxlength="5" size="5" onkeypress="return SoNumero(event);" onkeydown="Formata('frmInserirUsuario:comissao',3,2,event);"
