...
<body>
	...
	<h:form>
		<h:panelGrid columns="3" id="formGrid">
			...
			<h:selectOneRadio  styleClass="selectOneRadio" id="abrirGaveta" rendered="true"
			...
			<t:inputCalendar readonly="false" renderAsPopup="true" styleClass="inputText" value="#{formaRecebimentoBB.dataInicioValidade}" id="dataInicioValidade" popupDateFormat="dd/MM/yyyy"/>
			<h:message for="dataInicioValidade" styleClass="errors"/>
					
			<h:outputText styleClass="label" value="Final Validade"></h:outputText>
			<t:inputCalendar readonly="false" renderAsPopup="true" styleClass="inputText"  value="#{formaRecebimentoBB.dataFimValidade}" id="dataFimValidade" popupDateFormat="dd/MM/yyyy"/>
