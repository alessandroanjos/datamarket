		...
		<head>
			...
			<script type="text/javascript">
		        ...
		        function mostraCampos(str) {
			        ...
			        var form = document.forms["frmInserirPlanoPagamentoChequePre"];   
	                alert(str);
			        if (flag.toUpperCase() == "N") {
				        form["frmInserirPlanoPagamentoChequePre:quantidadeDias"].readonly="false"; 
			        } else {
						desabilita("frmInserirPlanoPagamentoChequePre:quantidadeDias");
						form["frmInserirPlanoPagamentoChequePre:quantidadeDias"].value="0"; 
						form["frmInserirPlanoPagamentoChequePre:quantidadeDias"].readonly="true"; 
			        }
		      }		
			</script>
										...
										<li class="normal">
											...
											<div>
												...
												<h:inputText styleClass="field text" id="percentualParcela"
													...
													dir="rtl" required="false" onkeypress="return SoNumero();"
													onkeypress="return SoNumero(event);"
