	...
	<head>
		...
		<t:stylesheet path="/EnterpriseServer/css/form.css"></t:stylesheet>
				...
				<f:subview id="subTopo" rendered="true">
					<jsp:include page="/jsp/topo.jsp?tituloPagina=#{msgs.manterCliente}&user=#{loginBB.usuarioLogado.nome}"></jsp:include>	
				</f:subview>					
				<div id="content">
					<div id="tabMenu">
						<ul>
							...
							<ul>
								...
								<li class="normal">
									<div>
										...
										<h:inputText styleClass="text field" dir="rtl" id="valorLimiteCompras" maxlength="10" size="10" value="#{clienteBB.valorLimiteCompras}" required="true" onkeypress="Formata('frmManterCliente:valorLimiteCompras',9,2);">
