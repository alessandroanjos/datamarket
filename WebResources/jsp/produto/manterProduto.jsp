			...
			<script type="text/javascript">
	              ...
	              function showPopUp(action, form, target) {
                		...
                		if(getId("frmManterProduto:idProdutoComposicao").value == ""){        		
							...
							document.forms["frmManterProduto"].action = "/EnterpriseServer/jsp/produto/manterProduto.faces?acaoLocal=pesquisarProdutos&codigoProduto="+getId("frmManterProduto:idProdutoComposicao").value;
							document.forms["frmManterProduto"].submit();                	
		                }
		          }
		...
		<body onload="exibirMensagemErro();inicializar();">
			<div id="outer">
				...
				<div id="content">
					...
					<div id="primarioContentContainerInternas">
					<h:form id="frmManterProduto" binding="#{produtoBB.init}"
							onsubmit="javascript:getId('frmManterProduto:abaCorrente').value = strAbaCorrente;">
						<ul>
							<li class="normal">
								<div>
									...
									<li class="normal">
										<div>
											...
											<h:commandButton immediate="true" image="/images/pesquisa.png" alt="Pesquisar Produto" styleClass="btTxt" id="botaoConsultarProduto"
												onmousedown="showPopUp(this,'frmManterProduto','find')"
