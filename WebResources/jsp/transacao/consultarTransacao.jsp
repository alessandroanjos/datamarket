				...
				<div id="content">				
						<div id="primarioContentContainer">
							...
							<div class="listagem">
								...
								<div>
									<%@ include file="/jsp/mensagem_erro.jsp"%> <!--  h  messages rendered="#{not transacaoBB.existeRegistros}" errorClass="msgSistemaErro" infoClass="msgSistemaSucesso" globalOnly="true" showDetail="true" /> -->
								</div>
							</div>
							<ul>
								<li class="buttons">
