	...
	<head>
		...
		<script type="text/javascript">
            ...
            function showPopUpClientes(action, form, target) {
	            ...
	            if(getId("frmInserirTransacao:cpfCnpjClienteCadastro").value == ""){        		
	                   formIdClientes = form;
				    ...
				    var cpfCnpjTmp = getId("frmInserirTransacao:cpfCnpjClienteCadastro").value;
					document.forms["frmInserirTransacao"].action = "/EnterpriseServer/jsp/transacao/inserirTransacao.faces?acaoLocal=pesquisarClientes&cpfCnpj="+cpfCnpjTmp;
					document.forms["frmInserirTransacao"].submit();                  	
               }
           }
           ...
           //
            function setAtributoClientes(cpfCnpj,nomeCliente, razaoSocial, tipoPessoa) {
                ...
                if(tipoPessoa == "F"){
                    ...
                    /*form[formIdClientes+":inscricaoEstadualCadastro"].value = razaoSocial;
                    form[formIdClientes+":inscricaoMunicipalCadastro"].value = razaoSocial;*/
                }
                
               /* form[formIdClientes+":logradouroCadastro"].value = logradouro;
                form[formIdClientes+":numeroCadastro"].value = numero;
                form[formIdClientes+":complementoCadastro"].value = complemento;
                form[formIdClientes+":bairroCadastro"].value = bairro;
                form[formIdClientes+":cidadeCadastro"].value = cidade;
                form[formIdClientes+":cepCadastro"].value = cep;
                form[formIdClientes+":estadoCadastro"].value = estado;
                form[formIdClientes+":foneResidencialCadastro"].value = foneResidencial;
                form[formIdClientes+":foneCelularCadastro"].value = foneCelular;
                form[formIdClientes+":pessoaContatoCadastro"].value = pessoaContato;
                form[formIdClientes+":foneContatoCadastro"].value = foneContato;
                form[formIdClientes+":referenciaBancariaCadastro"].value = referenciaBancaria;
                form[formIdClientes+":emailCadastro"].value = email;  */              
							...
							<ul>
								<li class="normal">
									...
									<div>
										...
										<h:inputText styleClass="field monetario" id="precoVenda" maxlength="10" size="10"
									...
									<div>
										...
										<h:inputText styleClass="field monetario" id="quantidade" maxlength="9" size="9"
									...
									<div>
										...
										<h:inputText styleClass="field monetario" id="descontoItem" maxlength="10" size="10"
									...
									<div>
										...
										<h:inputText styleClass="field monetario" id="valorItem" maxlength="10" size="10" readonly="true"
						...
						<ul>
							<li class="normal">
								...
								<div>
									...
									<h:inputText styleClass="field monetario" id="valorFormaPagamento" maxlength="10" size="10" readonly="false"
									...
									<li class="normal">
										...
										<div>
											...
											<h:commandButton image="/images/pesquisa.png" alt="Pesquisar Cliente" styleClass="btTxt" id="botaoConsultarCliente"
												onmousedown="showPopUpClientes(this,'frmInserirTransacao','find')" value="">
											</h:commandButton>							
										</div>
					...
					<ul>		
						...
						<li class="normal">
							<div>
								...
								<h:inputText styleClass="field monetario" id="valorSubTotalCupom" maxlength="10" size="10"
							...
							<div>
								...
								<h:inputText styleClass="field monetario" id="valorTotalRecebido" maxlength="10" size="10"
							...
							<div>
								<h:outputLabel styleClass="desc" value="Desconto"></h:outputLabel>
								<h:inputText styleClass="field monetario" id="descontoCupom" maxlength="10" size="10" onblur="reCalculaTotalCupom();"
							...
							<div>
								...
								<h:inputText styleClass="field monetario" id="valorTroco" maxlength="10" size="10" onblur="reCalculaTotalCupom();"
							...
							<div>
								...
								<h:inputText styleClass="field monetario" id="valorTotalCupom" maxlength="10" size="10" readonly="false"
