					...
					<fieldset>
									...
									<li class="normal">									
										<div>
											...
											<h:selectOneRadio  styleClass="field select tipopessoa" id="idTipoPessoa" 
												value="#{clienteTransacaoBB.idTipoPessoa}" layout="lineDirection" required="true">
							...
							<div class="listagem">
								...
								<ul>
									<li class="normal">
										<div>
											<h:messages rendered="#{not clienteTransacaoBB.existeRegistros}" errorClass="msgSistemaErro" infoClass="msgSistemaSucesso" globalOnly="true" showDetail="true"/>
										</div>
									</li>
								</ul>	
							</div>
