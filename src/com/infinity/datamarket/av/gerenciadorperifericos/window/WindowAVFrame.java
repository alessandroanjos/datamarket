package com.infinity.datamarket.av.gerenciadorperifericos.window;
...
public class WindowAVFrame implements Window{
	...
	public void atualizaLote(int lote){
		frame.setTitle("INFINITY - DATAMARKET - AV | DADOS "+lote);
	}
