...
public class OpAVConfirmaEncerraAlteracaoPedido extends Mic {

	public int exec(GerenciadorPerifericos gerenciadorPerifericos, ParametroMacroOperacao param){
		try{
			
			gerenciadorPerifericos.getDisplay().setMensagem(MensagensAV.getMensagem(this, "Cancelar Alter. Pedido?"));
