...
public class OpAVIniciaAlteracaoPedido extends OpAVEncerraPedido {


	public int exec(GerenciadorPerifericos gerenciadorPerifericos, ParametroMacroOperacao param){
		try{

			gerenciadorPerifericos.getCmos().gravar(CMOS.OPERACAO_ATUAL, CMOS.OPERACAO_ALTERACAO_PEDIDO);
			...
			tela.setCampoOperacao("Alteração Pedido");
