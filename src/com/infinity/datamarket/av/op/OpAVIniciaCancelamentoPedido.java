...
public class OpAVIniciaCancelamentoPedido extends OpAVEncerraPedido {


	public int exec(GerenciadorPerifericos gerenciadorPerifericos, ParametroMacroOperacao param){
		try{

			gerenciadorPerifericos.getCmos().gravar(CMOS.OPERACAO_ATUAL, CMOS.OPERACAO_CANCELAMENTO_PEDIDO);
			...
			tela.setCampoOperacao("Cancela Pedido");
