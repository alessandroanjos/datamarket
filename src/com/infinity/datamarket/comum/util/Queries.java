...
public class Queries {
	...
	public static final String RELATORIO_LANCAMENTOS_CONTAS_EM_ABERTO;
	public static final String RELATORIO_LANCAMENTOS_CONTAS_FINALIZADAS;
	public static final String RELATORIO_LANCAMENTOS_CONTAS_VENCIDAS;
	...
	static {
			...
			RELATORIO_LANCAMENTOS_CONTAS_EM_ABERTO = rs.getString("RELATORIO_LANCAMENTOS_CONTAS_EM_ABERTO");
			RELATORIO_LANCAMENTOS_CONTAS_FINALIZADAS = rs.getString("RELATORIO_LANCAMENTOS_CONTAS_FINALIZADAS");
			RELATORIO_LANCAMENTOS_CONTAS_VENCIDAS = rs.getString("RELATORIO_LANCAMENTOS_CONTAS_VENCIDAS");
	}
