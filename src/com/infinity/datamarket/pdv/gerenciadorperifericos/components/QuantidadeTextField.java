...
import javax.swing.SwingUtilities;
	...
	public class QuantidadeTextField  extends JTextField implements FocusListener,
			KeyListener, MouseListener {

		
		private static final long serialVersionUID = -2235120694382447126L;

		/**
		 * Construtor vazio
		 */
		public QuantidadeTextField() {
			setDocument(new QuantidadeDocument());
		 ...
		 */
		public QuantidadeTextField(String valorInicial) {
			setDocument(new QuantidadeDocument());
			setHorizontalAlignment(SwingConstants.RIGHT);
			adicionaListeners();
		...
		public double getValor(){
			...
			try {
				QuantidadeDocument doc = (QuantidadeDocument) getDocument();
...
//				}
		...
		public static void main(String[] a){
			...
			QuantidadeTextField b = new QuantidadeTextField();
