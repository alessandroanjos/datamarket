...
//	        imp.inicioOperador(new BigDecimal(20.00), "DINHEIRO");
	        ...
	        imp.vendeItem("123", "Caneta", "18.00", "I", new BigDecimal("1"),"UN" ,new BigDecimal("15"),ImpressoraFiscal.DESCONTO_VALOR,new BigDecimal("0.3"));
//	        imp.cancelaItem("002");
	        
	        System.out.println(imp.getNumeroCupom());
	        
	        imp.iniciaFechamentoCupom(BigDecimal.ZERO,BigDecimal.ZERO);
